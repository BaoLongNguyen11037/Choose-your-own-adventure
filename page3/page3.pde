...
color white = #FAFAFA, skyBlue = #6680E6, yellow = #FFFF4D, gray = #CCCCCC, oak = #CC9933, brown = #994D00, green = #336633, darkGray = #4D4D4D, black = #000000, beige = #E6E6CC,
frameColor = white, skyColor = skyBlue, cloudColor = white, sunColor = yellow, defaultColor = gray, towerColor = oak, doorColor = brown, grassColor = green, barnwallColor = brown,
