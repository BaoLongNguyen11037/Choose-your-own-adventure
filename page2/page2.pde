...
//Declare readable variables for colours
color oak = #BB8141, black = #000000,  lightGray = #a1a1a1, white = #FFFFFF, darkGray = #505050,
deskColor = oak, laptopColor = black, screenColor = lightGray, defaultColor = white, keyboardColor = darkGray, touchpadColor = lightGray;
